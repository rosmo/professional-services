...
namespace GSnapshot
{
    class Program
    {
        private static IServiceProvider BuildDI(IConfiguration config, Microsoft.Extensions.Logging.LogLevel logLevel)
        {
        ...
        static void HandleParseError(IEnumerable<Error> errs)
        {
            ...
            foreach (var error in errs)
            {
                ...
                {
                    CommandLine.MissingGroupOptionError optionError = (CommandLine.MissingGroupOptionError)error;
                    errorWriter.WriteLine("  " + CommandLine.MissingGroupOptionError.ErrorMessage + " (" + optionError.Group + ")");
                }
            }
        ...
        static void RunOptions(Options opts)
        {
            ...
            try
            {
                ...
                var servicesProvider = BuildDI(config, opts.Verbose ? Microsoft.Extensions.Logging.LogLevel.Debug : Microsoft.Extensions.Logging.LogLevel.Information);
